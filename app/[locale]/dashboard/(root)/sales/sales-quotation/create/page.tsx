"use client";
import AddSalesQuotationForm from "@/components/dashboard/forms/sales/SalesQuotationForm";
...
export default function CreateSalesQuotation() {
  ...
  const handleSubmit = async (data:any) => {
    console.log("Form data submitted from parent:", data);
      try {
      console.log("submit btn clickedddddddddddd");
      const payload = {
        ...data,
  ...
  return (
    <main className="mx-7 my-5">
      ...
      <AddSalesQuotationForm onSubmit={handleSubmit} />
