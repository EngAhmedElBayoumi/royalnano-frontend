      ...
      <div className="flex justify-center">
        <main className="main-container grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-[10%] items-center">
          <ul className="space-y-4">
            {services.map((service: { key?: any; name: any; id?: number; alias?: string; description?: string; image?: string | null; created_at?: string; type?: string | undefined; }, index: React.Key | null | undefined) => (
              <ServiceItem
                key={index}
                service={{
                  ...service,
