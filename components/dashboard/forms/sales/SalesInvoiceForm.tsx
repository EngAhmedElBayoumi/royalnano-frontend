        ...
        <section className="min-h-[60vh]">
          <div className="grid sm:grid-cols-2 gap-x-4 gap-y-2 xl:gap-y-5 lg:gap-x-10">
            <TextInput
              ...
              name="date"
              label={t("SalesInvoice.date")}
              placeholder={t("SalesInvoice.date")}
            />
            <TextInput
              control={form.control}
              name="customer"
            ...
            <TextInput
              ...
              label={t("SalesInvoice.validityPeriod")}
              placeholder={t("SalesInvoice.validityPeriod")}
            />
            <TextInput
              control={form.control}
              name="quotation_number"
              label={t("SalesInvoice.quotationNumber")}
              placeholder={t("SalesInvoice.quotationNumber")}
            />
          </div>
        </section>
